...
class APCHead(BaseDecodeHead):
    ...
    def __init__(self, pool_scales=(1, 2, 3, 6), fusion=True, in_channels=768, num_classes=6, channels=512, in_index=3):
        super(APCHead, self).__init__(in_index=in_index, in_channels=in_channels,
                                      num_classes=num_classes, channels=channels, dropout_ratio=0.1, norm_cfg=norm_cfg, align_corners=False)
