...
class BiSeNetV2(nn.Module):
    ...
    def __init__(self, nclass):
        ...
        self.head = SegmentHead(128, 1024, nclass)
        self.aux2 = SegmentHead(16, 128, nclass)
        self.aux3 = SegmentHead(32, 128, nclass)
        self.aux4 = SegmentHead(64, 128, nclass)
        self.aux5_4 = SegmentHead(128, 128, nclass)
    ...
    def forward(self, x):
        ...
        outputs = []
        list_out = (logits, logits_aux2, logits_aux3, logits_aux4, logits_aux5_4)
        for out in list_out:
            outputs.append(out)
        return outputs
